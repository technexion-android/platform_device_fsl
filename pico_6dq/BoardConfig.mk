...
TARGET_RECOVERY_FSTAB = device/fsl/pico_6dq/fstab.freescale.car
PRODUCT_COPY_FILES +=	\
	device/fsl/pico_6dq/fstab.freescale.car:root/fstab.freescale
else
...
ifeq ($(PRODUCT_IMX_CAR),true)
PRODUCT_COPY_FILES += \
    device/fsl/pico_6dq/manifest_car.xml:vendor/manifest.xml
else
PRODUCT_COPY_FILES += \
    device/fsl/pico_6dq/manifest.xml:vendor/manifest.xml
endif

TARGET_BOOTLOADER_BOARD_NAME := pico_6dq
PRODUCT_MODEL := PICO-MX6DL
...
BOARD_VENDOR_KERNEL_MODULES += \
                            device/fsl/pico_6dq/wifi-firmware/wlan.ko
...
UBI_ROOT_INI := device/fsl/pico_6dq/ubi/ubinize.ini
...
PRODUCT_COPY_FILES +=	\
       device/fsl/pico_6dq/ueventd.freescale.rc:root/ueventd.freescale.rc
...
PRODUCT_COPY_FILES += \
       device/fsl/pico_6dq/seccomp/mediacodec-seccomp.policy:vendor/etc/seccomp_policy/mediacodec.policy \
       device/fsl/pico_6dq/seccomp/mediaextractor-seccomp.policy:vendor/etc/seccomp_policy/mediaextractor.policy

PRODUCT_COPY_FILES += \
       device/fsl/pico_6dq/app_whitelist.xml:system/etc/sysconfig/app_whitelist.xml
