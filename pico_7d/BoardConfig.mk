...
#
include device/fsl/imx7/soc/pico_7d.mk
...
# pico_7d default target for EXT4
...
PRODUCT_COPY_FILES += \
    device/fsl/pico_7d/manifest.xml:vendor/manifest.xml

TARGET_BOOTLOADER_BOARD_NAME := pico_7d
PRODUCT_MODEL := PICO-MX7D
...
BOARD_VENDOR_KERNEL_MODULES += \
                            device/fsl/pico_7d/wifi-firmware/wlan.ko
...
PRODUCT_COPY_FILES +=	\
       device/fsl/pico_7d/ueventd.freescale.rc:root/ueventd.freescale.rc

# Vendor seccomp policy files for media components:
PRODUCT_COPY_FILES += \
       device/fsl/pico_7d/seccomp/mediacodec-seccomp.policy:vendor/etc/seccomp_policy/mediacodec.policy \
       device/fsl/pico_7d/seccomp/mediaextractor-seccomp.policy:vendor/etc/seccomp_policy/mediaextractor.policy

PRODUCT_COPY_FILES += \
       device/fsl/pico_7d/app_whitelist.xml:system/etc/sysconfig/app_whitelist.xml
