...
PRODUCT_COPY_FILES += \
	...
	device/fsl/pico_6dq/audio_policy_configuration.xml:system/etc/audio_policy_configuration.xml \
...
# busybox login files
PRODUCT_COPY_FILES += \
        device/fsl/pico_6dq/bin/login:system/bin/login \
        device/fsl/pico_6dq/bin/busybox:system/bin/busybox \
        device/fsl/pico_6dq/bin/Technexion.sh:/system/bin/Technexion.sh
...
PRODUCT_COPY_FILES += \
	device/fsl/pico_6dq/brcm-firmware/bcmdhd.cal:system/etc/firmware/bcm/bcmdhd.cal 	\
	device/fsl/pico_6dq/brcm-firmware/fw_bcmdhd.bin:system/etc/firmware/bcm/fw_bcmdhd.bin 	\
	device/fsl/pico_6dq/brcm-firmware/fw_bcmdhd_apsta.bin:system/etc/firmware/bcm/fw_bcmdhd_apsta.bin 	\
	device/fsl/pico_6dq/brcm-firmware/bcm43438a0.hcd:system/etc/firmware/bcm/bcm43438a0.hcd 	\
	device/fsl/pico_6dq/brcm-firmware/fw_bcm43438a0.bin:system/etc/firmware/bcm/fw_bcm43438a0.bin 	\
	device/fsl/pico_6dq/brcm-firmware/fw_bcm43438a0_apsta.bin:system/etc/firmware/bcm/fw_bcm43438a0_apsta.bin 	\
	device/fsl/pico_6dq/brcm-firmware/fw_bcm43438a0_p2p.bin:system/etc/firmware/bcm/fw_bcm43438a0_p2p.bin 	\
	device/fsl/pico_6dq/brcm-firmware/nvram_ap6212.txt:system/etc/firmware/bcm/nvram_ap6212.txt 	\
