...
PRODUCT_COPY_FILES += \
	...
	device/fsl/pico_6dq/init.imx6q.rc:root/init.freescale.imx6q.rc \
	device/fsl/pico_6dq/init.imx6dl.rc:root/init.freescale.imx6dl.rc \
	device/fsl/pico_6dq/init.imx6qp.rc:root/init.freescale.imx6qp.rc \

PRODUCT_COPY_FILES += device/fsl/pico_6dq/init.freescale.emmc.rc:root/init.freescale.emmc.rc
PRODUCT_COPY_FILES += device/fsl/pico_6dq/init.freescale.sd.rc:root/init.freescale.sd.rc

# Audio
USE_XML_AUDIO_POLICY_CONF := 1
PRODUCT_COPY_FILES += \
	device/fsl/pico_6dq/audio_policy_hdmi.conf:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy.conf \
	device/fsl/pico_6dq/audio_effects.conf:$(TARGET_COPY_OUT_VENDOR)/etc/audio_effects.conf \
	device/fsl/pico_6dq/audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration.xml \
...
PRODUCT_COPY_FILES += \
	device/fsl/pico_6dq/tablet_core_hardware.xml:system/etc/permissions/tablet_core_hardware.xml \
...
# Atheros wifi file
#	out/target/product/pico_6dq/obj/KERNEL_OBJ/drivers/net/wireless/ath/ath.ko:system/lib/modules/ath.ko \
#	out/target/product/pico_6dq/obj/KERNEL_OBJ/drivers/net/wireless/ath/ath10k/ath10k_core.ko:system/lib/modules/ath10k_core.ko \
#	out/target/product/pico_6dq/obj/KERNEL_OBJ/drivers/net/wireless/ath/ath10k/ath10k_sdio.ko:system/lib/modules/ath10k_sdio.ko \
#	device/fsl/pico_6dq/wifi-firmware/ath.ko:system/lib/modules/ath.ko \
#	device/fsl/pico_6dq/wifi-firmware/ath10k_core.ko:system/lib/modules/ath10k_core.ko \
...
PRODUCT_COPY_FILES += \
	device/fsl/pico_6dq/wifi-firmware/QCA9377/hw1.0/board.bin:vendor/lib/firmware/ath10k/QCA9377/hw1.0/board.bin \
	device/fsl/pico_6dq/wifi-firmware/QCA9377/hw1.0/board-2.bin:vendor/lib/firmware/ath10k/QCA9377/hw1.0/board-2.bin \
	device/fsl/pico_6dq/wifi-firmware/QCA9377/hw1.0/board-sdio.bin:vendor/lib/firmware/ath10k/QCA9377/hw1.0/board-sdio.bin \
