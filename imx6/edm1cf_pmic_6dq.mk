...
PRODUCT_COPY_FILES += \
        ...
        device/fsl/edm1cf_pmic_6dq/init.i.MX6Q.rc:root/init.freescale.i.MX6Q.rc \
        device/fsl/edm1cf_pmic_6dq/init.i.MX6DL.rc:root/init.freescale.i.MX6DL.rc \
        device/fsl/edm1cf_pmic_6dq/init.i.MX6QP.rc:root/init.freescale.i.MX6QP.rc

# Audio
USE_XML_AUDIO_POLICY_CONF := 1
PRODUCT_COPY_FILES += \
	device/fsl/edm1cf_pmic_6dq/audio_effects.conf:system/vendor/etc/audio_effects.conf \
	device/fsl/edm1cf_pmic_6dq/audio_policy_configuration.xml:system/etc/audio_policy_configuration.xml \
...
PRODUCT_COPY_FILES += \
	device/fsl/edm1cf_pmic_6dq/bluetooth/bt_reset:system/bin/bt_reset \
	device/fsl/edm1cf_pmic_6dq/bluetooth/bd_mac_gen:system/bin/bd_mac_gen


# ethernet files
PRODUCT_COPY_FILES += \
	device/fsl/edm1cf_pmic_6dq/ethernet/eth_updown:system/bin/eth_updown \
	device/fsl/edm1cf_pmic_6dq/ethernet/eth_flag:system/bin/eth_flag
...
# busybox login files
PRODUCT_COPY_FILES += \
        device/fsl/edm1cf_pmic_6dq/bin/login:system/bin/login \
        device/fsl/edm1cf_pmic_6dq/bin/busybox:system/bin/busybox \
        device/fsl/edm1cf_pmic_6dq/bin/Technexion.sh:/system/bin/Technexion.sh
...
PRODUCT_COPY_FILES += \
	device/fsl/edm1cf_pmic_6dq/brcm-firmware/bcm43438a0.hcd:system/etc/firmware/bcm/bcm43438a0.hcd 	\
	device/fsl/edm1cf_pmic_6dq/brcm-firmware/fw_bcm43438a0.bin:system/etc/firmware/bcm/fw_bcm43438a0.bin 	\
	device/fsl/edm1cf_pmic_6dq/brcm-firmware/fw_bcm43438a0_apsta.bin:system/etc/firmware/bcm/fw_bcm43438a0_apsta.bin 	\
	device/fsl/edm1cf_pmic_6dq/brcm-firmware/fw_bcm43438a0_p2p.bin:system/etc/firmware/bcm/fw_bcm43438a0_p2p.bin 	\
	device/fsl/edm1cf_pmic_6dq/brcm-firmware/nvram_ap6212.txt:system/etc/firmware/bcm/nvram_ap6212.txt 	\
