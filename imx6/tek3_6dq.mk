...
PRODUCT_COPY_FILES += \
	...
	device/fsl/tek3_6dq/audio_policy_configuration.xml:system/etc/audio_policy_configuration.xml \
...
# busybox login files
PRODUCT_COPY_FILES += \
        device/fsl/tek3_6dq/bin/login:system/bin/login \
        device/fsl/tek3_6dq/bin/busybox:system/bin/busybox \
        device/fsl/tek3_6dq/bin/Technexion.sh:/system/bin/Technexion.sh
...
PRODUCT_COPY_FILES += \
	device/fsl/tek3_6dq/brcm-firmware/bcm43438a0.hcd:system/etc/firmware/bcm/bcm43438a0.hcd 	\
	device/fsl/tek3_6dq/brcm-firmware/fw_bcm43438a0.bin:system/etc/firmware/bcm/fw_bcm43438a0.bin 	\
	device/fsl/tek3_6dq/brcm-firmware/fw_bcm43438a0_apsta.bin:system/etc/firmware/bcm/fw_bcm43438a0_apsta.bin 	\
	device/fsl/tek3_6dq/brcm-firmware/fw_bcm43438a0_p2p.bin:system/etc/firmware/bcm/fw_bcm43438a0_p2p.bin 	\
	device/fsl/tek3_6dq/brcm-firmware/nvram_ap6212.txt:system/etc/firmware/bcm/nvram_ap6212.txt 	\
