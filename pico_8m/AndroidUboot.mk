...
define build_uboot
	cp out/target/product/pico_8m/obj/BOOTLOADER_OBJ/u-boot-nodtb.$(strip $(1)) $(IMX_MKIMAGE_PATH)/imx-mkimage/iMX8M/.; \
	cp out/target/product/pico_8m/obj/BOOTLOADER_OBJ/spl/u-boot-spl.bin  $(IMX_MKIMAGE_PATH)/imx-mkimage/iMX8M/.; \
	cp out/target/product/pico_8m/obj/BOOTLOADER_OBJ/tools/mkimage  $(IMX_MKIMAGE_PATH)/imx-mkimage/iMX8M/mkimage_uboot; \
	cp out/target/product/pico_8m/obj/BOOTLOADER_OBJ/arch/arm/dts/pico_8m.dtb  $(IMX_MKIMAGE_PATH)/imx-mkimage/iMX8M/.; \
