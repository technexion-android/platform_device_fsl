...
IMX_DEVICE_PATH := device/nxp/imx8m/edm_g_imx8mm
...
ifeq ($(TN_DEFAULT_CAMERA),TEVI_OV564X)
    PRODUCT_COPY_FILES +=\
        device/nxp/imx8m/edm_g_imx8mm/camera_config_imx8mm.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/camera_config_imx8mm.json
else ifeq ($(TN_DEFAULT_CAMERA),TEVI_UVC)
    PRODUCT_COPY_FILES +=\
        device/nxp/imx8m/edm_g_imx8mm/camera_config_imx8mm_tevi-uvc.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/camera_config_imx8mm.json
else ifeq ($(TN_DEFAULT_CAMERA),DUAL)
    PRODUCT_COPY_FILES +=\
        device/nxp/imx8m/edm_g_imx8mm/camera_config_imx8mm_dual.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/camera_config_imx8mm.json
endif

PRODUCT_COPY_FILES +=\
    device/nxp/imx8m/edm_g_imx8mm/external_camera_config.xml:$(TARGET_COPY_OUT_VENDOR)/etc/external_camera_config.xml
...
PRODUCT_COPY_FILES += \
    device/nxp/imx8m/edm_g_imx8mm/powerhint_imx8mm.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/powerhint_imx8mm.json
...
PRODUCT_COPY_FILES += \
    device/nxp/imx8m/edm_g_imx8mm/thermal_info_config_imx8mm.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/thermal_info_config_imx8mm.json
endif
...
ifneq ($(filter TRUE true 1,$(IMX_OTA_POSTINSTALL)),)
  ...
  PRODUCT_COPY_FILES += \
    out/target/product/edm_g_imx8mm/obj/UBOOT_COLLECTION/u-boot-imx8mm.imx:$(TARGET_COPY_OUT_VENDOR)/etc/bootloader0.img
endif
