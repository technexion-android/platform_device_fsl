...
# copy drm specific files before inherit edm_g_imx8mm.mk, otherwise copy is ignored
PRODUCT_COPY_FILES += \
...
$(call inherit-product, $(TOPDIR)$(IMX_DEVICE_PATH)/edm_g_imx8mm.mk)

TARGET_KERNEL_DEFCONFIG := tn_imx8_android_defconfig


# Overrides
PRODUCT_NAME := edm_g_imx8mm_drm
