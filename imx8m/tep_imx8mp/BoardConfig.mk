...
# qca9377-5(pcie) wifi driver module
BOARD_VENDOR_KERNEL_MODULES += $(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/drivers/net/wireless/ath/ath.ko \
                               $(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/drivers/net/wireless/ath/ath10k/ath10k_core.ko \
                               $(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/drivers/net/wireless/ath/ath10k/ath10k_pci.ko
...
# QCA9377-5 BT with USB interface
BOARD_VENDOR_KERNEL_MODULES += $(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/drivers/bluetooth/btrtl.ko \
                               $(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/drivers/bluetooth/btintel.ko \
                               $(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/drivers/bluetooth/btusb.ko
...
TARGET_BOARD_DTS_CONFIG := imx8mp:imx8mp-tep_android.dtb
TARGET_BOARD_DTS_CONFIG += imx8mp-rpmsg:imx8mp-tep-rpmsg_android.dtb

WITH_EXT_DTBO ?= true
ifeq ($(WITH_EXT_DTBO),true)
	TARGET_BOARD_DTBO_CONFIG := imx8mp:imx8mp-tep-hdmi2mipi-tc358743.dtbo
	TARGET_BOARD_DTBO_CONFIG += imx8mp:imx8mp-tep-lvds-vl10112880.dtbo
	TARGET_BOARD_DTBO_CONFIG += imx8mp:imx8mp-tep-lvds-vl15010276.dtbo
	TARGET_BOARD_DTBO_CONFIG += imx8mp:imx8mp-tep-lvds-vl156192108.dtbo
	TARGET_BOARD_DTBO_CONFIG += imx8mp:imx8mp-tep-lvds-vl215192108.dtbo
