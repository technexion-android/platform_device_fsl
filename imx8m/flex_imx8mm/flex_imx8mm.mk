...
IMX_DEVICE_PATH := device/fsl/imx8m/flex_imx8mm
...
# Overrides
PRODUCT_NAME := flex_imx8mm
PRODUCT_DEVICE := flex_imx8mm
...
ifneq (,$(wildcard device/fsl/imx8m/flex_imx8mm/bluetooth/rampatch_tlv_3.2.tlv))
PRODUCT_COPY_FILES += \
device/fsl/imx8m/flex_imx8mm/bluetooth/rampatch_tlv_3.2.tlv:$(TARGET_COPY_OUT_VENDOR)/firmware/qca/rampatch_tlv_tf_1.0.tlv \
device/fsl/imx8m/flex_imx8mm/bluetooth/rampatch_tlv_3.2.tlv:$(TARGET_COPY_OUT_VENDOR)/firmware/qca/tfbtfw11.tlv
endif
ifneq (,$(wildcard device/fsl/imx8m/flex_imx8mm/bluetooth/nvm_tlv_3.2.bin))
PRODUCT_COPY_FILES += \
device/fsl/imx8m/flex_imx8mm/bluetooth/nvm_tlv_3.2.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/qca/nvm_tlv_tf_1.0.bin \
device/fsl/imx8m/flex_imx8mm/bluetooth/nvm_tlv_3.2.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/qca/tfbtnv11.bin
endif
...
# Qcom WiFi Firmware
ifneq (,$(wildcard device/fsl/imx8m/flex_imx8mm/wifi-firmware/QCA9377/wlan/cfg.dat))
PRODUCT_COPY_FILES += \
device/fsl/imx8m/flex_imx8mm/wifi-firmware/QCA9377/wlan/cfg.dat:vendor/firmware/wlan/cfg.dat
endif
ifneq (,$(wildcard device/fsl/imx8m/flex_imx8mm/wifi-firmware/QCA9377/wlan/qcom_cfg.ini))
PRODUCT_COPY_FILES += \
device/fsl/imx8m/flex_imx8mm/wifi-firmware/QCA9377/wlan/qcom_cfg.ini:vendor/firmware/wlan/qcom_cfg.ini
endif
ifneq (,$(wildcard device/fsl/imx8m/flex_imx8mm/wifi-firmware/QCA9377/bdwlan30.bin))
PRODUCT_COPY_FILES += \
device/fsl/imx8m/flex_imx8mm/wifi-firmware/QCA9377/bdwlan30.bin:vendor/firmware/bdwlan30.bin
endif
ifneq (,$(wildcard device/fsl/imx8m/flex_imx8mm/wifi-firmware/QCA9377/otp30.bin))
PRODUCT_COPY_FILES += \
device/fsl/imx8m/flex_imx8mm/wifi-firmware/QCA9377/otp30.bin:vendor/firmware/otp30.bin
endif
ifneq (,$(wildcard device/fsl/imx8m/flex_imx8mm/wifi-firmware/QCA9377/qwlan30.bin))
PRODUCT_COPY_FILES += \
device/fsl/imx8m/flex_imx8mm/wifi-firmware/QCA9377/qwlan30.bin:vendor/firmware/qwlan30.bin
endif
ifneq (,$(wildcard device/fsl/imx8m/flex_imx8mm/wifi-firmware/QCA9377/utf30.bin))
PRODUCT_COPY_FILES += \
device/fsl/imx8m/flex_imx8mm/wifi-firmware/QCA9377/utf30.bin:vendor/firmware/utf30.bin
endif
...
# bootanimation ui
PRODUCT_COPY_FILES += \
device/fsl/imx8m/flex_imx8mm/ui/bootanimation.zip:system/media/bootanimation.zip

# audio-hat relative firmware
PRODUCT_COPY_FILES += \
device/fsl/imx8m/flex_imx8mm/firmware/TFA9892N1A_stereo_32FS.cnt:vendor/firmware/tfa98xx.cnt
