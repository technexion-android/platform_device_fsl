...
PRODUCT_COPY_FILES += \
    $(IMX_MEDIA_CODEC_XML_PATH)/codec2/store/registry/c2_component_register_8mn:$(TARGET_COPY_OUT_VENDOR)/etc/c2_component_register
...
ifneq ($(filter TRUE true 1,$(IMX_OTA_POSTINSTALL)),)
  ...
  PRODUCT_COPY_FILES += \
    $(OUT_DIR)/target/product/$(firstword $(PRODUCT_DEVICE))/obj/UBOOT_COLLECTION/spl-imx8mn-trusty-dual.bin:$(TARGET_COPY_OUT_VENDOR)/etc/bootloader0.img
  ifeq ($(BUILD_ENCRYPTED_BOOT),true)
    PRODUCT_COPY_FILES += \
      $(OUT_DIR)/target/product/$(firstword $(PRODUCT_DEVICE))/obj/UBOOT_COLLECTION/bootloader-imx8mn-trusty-dual.img:$(TARGET_COPY_OUT_VENDOR)/etc/bootloader_ab.img
  endif
endif
...
PRODUCT_COPY_FILES += \
    ...
    hardware/nxp/libbt/conf/nxp/evk_8mn/bt_vendor.conf:/vendor/etc/bluetooth/bt_vendor.conf
