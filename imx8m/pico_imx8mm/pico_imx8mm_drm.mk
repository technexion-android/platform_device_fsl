...
# copy drm specific files before inherit pico_imx8mm.mk, otherwise copy is ignored
PRODUCT_COPY_FILES += \
...
$(call inherit-product, $(TOPDIR)$(IMX_DEVICE_PATH)/pico_imx8mm.mk)

TARGET_KERNEL_DEFCONFIG := android_defconfig


# Overrides
PRODUCT_NAME := pico_imx8mm_drm
