...
TARGET_BOARD_DTS_CONFIG := imx8mp:imx8mp-tek_android.dtb
TARGET_BOARD_DTS_CONFIG += imx8mp-rpmsg:imx8mp-tek-rpmsg_android.dtb

WITH_EXT_DTBO ?= true
ifeq ($(WITH_EXT_DTBO),true)
	TARGET_BOARD_DTBO_CONFIG := imx8mp:imx8mp-tek-hdmi2mipi-tc358743.dtbo
	TARGET_BOARD_DTBO_CONFIG += imx8mp:imx8mp-tek-vizionlink-tevi-ov5640.dtbo
	TARGET_BOARD_DTBO_CONFIG += imx8mp:imx8mp-tek-vizionlink-tevi-ap1302.dtbo
	TARGET_BOARD_DTBO_CONFIG += imx8mp:imx8mp-tek-vls.dtbo
endif
