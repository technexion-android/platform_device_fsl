...
SOC_MODEL := IMX8MP
SOC_MODEL_LT := imx8mp
PRODUCT_NAME := tek_${SOC_MODEL_LT}
PRODUCT_DEVICE := tek_${SOC_MODEL_LT}
PRODUCT_MODEL := TEK-${SOC_MODEL}
...
WIFI_FW_PATH := firmware/ath10k/QCA9377/hw1.0
...
ifeq ($(POWERSAVE),true)
PRODUCT_COPY_FILES += $(OUT_DIR)/target/product/$(firstword $(PRODUCT_DEVICE))/imx8mp_mcu_demo.bin:imx8mp_mcu_demo.img\
...
PRODUCT_COPY_FILES += $(FSL_PROPRIETARY_PATH)/fsl-proprietary/mcu-sdk/imx8mp/imx8mp_mcu_demo.img:imx8mp_mcu_demo.img\
 $(IMX_DEVICE_PATH)/audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration.xml
endif

PRODUCT_COPY_FILES += $(IMX_DEVICE_PATH)/audio_effects.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_effects.xml\
...
#endif
ifneq (,$(wildcard $(LOCAL_WIFI_PATH)/$(WIFI_FW_PATH)/board.bin))
PRODUCT_COPY_FILES += \
    $(LOCAL_WIFI_PATH)/$(WIFI_FW_PATH)/board.bin:$(TARGET_COPY_OUT_VENDOR)/$(WIFI_FW_PATH)/board.bin
endif
ifneq (,$(wildcard $(LOCAL_WIFI_PATH)/$(WIFI_FW_PATH)/board-2.bin))
PRODUCT_COPY_FILES += \
    $(LOCAL_WIFI_PATH)/$(WIFI_FW_PATH)/board-2.bin:$(TARGET_COPY_OUT_VENDOR)/$(WIFI_FW_PATH)/board-2.bin
endif
ifneq (,$(wildcard $(LOCAL_WIFI_PATH)/$(WIFI_FW_PATH)/firmware-5.bin))
PRODUCT_COPY_FILES += \
    $(LOCAL_WIFI_PATH)/$(WIFI_FW_PATH)/firmware-5.bin:$(TARGET_COPY_OUT_VENDOR)/$(WIFI_FW_PATH)/firmware-5.bin
endif
ifneq (,$(wildcard $(LOCAL_WIFI_PATH)/$(WIFI_FW_PATH)/LICENSE.qca_firmware))
PRODUCT_COPY_FILES += \
    $(LOCAL_WIFI_PATH)/$(WIFI_FW_PATH)/LICENSE.qca_firmware:$(TARGET_COPY_OUT_VENDOR)/$(WIFI_FW_PATH)/LICENSE.qca_firmware
endif
...
ifneq (,$(wildcard $(BT_FW_PATH)/nvm_usb_00000302.bin))
PRODUCT_COPY_FILES += \
    $(BT_FW_PATH)/nvm_usb_00000302.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/qca/nvm_usb_00000302.bin \
    $(BT_FW_PATH)/nvm_usb_00000302.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/qca/tfbtnv11.bin
endif
ifneq (,$(wildcard $(BT_FW_PATH)/rampatch_usb_00000302.bin))
PRODUCT_COPY_FILES += \
    $(BT_FW_PATH)/rampatch_usb_00000302.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/qca/rampatch_usb_00000302.bin \
    $(BT_FW_PATH)/rampatch_usb_00000302.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/qca/tfbtfw11.tlv
endif
# WCNSS execte binary
# Install Qcom BT HAL
PRODUCT_COPY_FILES += $(IMX_DEVICE_PATH)/bluetooth/wcnss_filter_8mp:$(TARGET_COPY_OUT_VENDOR)/bin/wcnss_filter
