...
# copy drm specific files before inherit edm_imx8m.mk, otherwise copy is ignored
PRODUCT_COPY_FILES += \
...
$(call inherit-product, $(TOPDIR)$(IMX_DEVICE_PATH)/edm_imx8m.mk)

TARGET_KERNEL_DEFCONFIG := android_defconfig


# Overrides
PRODUCT_NAME := edm_imx8m_drm
