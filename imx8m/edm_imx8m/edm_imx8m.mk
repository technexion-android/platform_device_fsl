...
IMX_DEVICE_PATH := device/fsl/imx8m/edm_imx8m
...
# Overrides
PRODUCT_NAME := edm_imx8m
PRODUCT_DEVICE := edm_imx8m
...
# Qcom WiFi Firmware
ifneq (,$(wildcard device/fsl/imx8m/edm_imx8m/wifi-firmware/QCA9377/wlan/cfg.dat))
PRODUCT_COPY_FILES += \
    device/fsl/imx8m/edm_imx8m/wifi-firmware/QCA9377/wlan/cfg.dat:vendor/firmware/wlan/cfg.dat
endif
ifneq (,$(wildcard device/fsl/imx8m/edm_imx8m/wifi-firmware/QCA9377/wlan/qcom_cfg.ini))
PRODUCT_COPY_FILES += \
    device/fsl/imx8m/edm_imx8m/wifi-firmware/QCA9377/wlan/qcom_cfg.ini:vendor/firmware/wlan/qcom_cfg.ini
endif
ifneq (,$(wildcard device/fsl/imx8m/edm_imx8m/wifi-firmware/QCA9377/bdwlan30.bin))
PRODUCT_COPY_FILES += \
    device/fsl/imx8m/edm_imx8m/wifi-firmware/QCA9377/bdwlan30.bin:vendor/firmware/bdwlan30.bin
endif
ifneq (,$(wildcard device/fsl/imx8m/edm_imx8m/wifi-firmware/QCA9377/otp30.bin))
PRODUCT_COPY_FILES += \
    device/fsl/imx8m/edm_imx8m/wifi-firmware/QCA9377/otp30.bin:vendor/firmware/otp30.bin
endif
ifneq (,$(wildcard device/fsl/imx8m/edm_imx8m/wifi-firmware/QCA9377/qwlan30.bin))
PRODUCT_COPY_FILES += \
    device/fsl/imx8m/edm_imx8m/wifi-firmware/QCA9377/qwlan30.bin:vendor/firmware/qwlan30.bin
endif
ifneq (,$(wildcard device/fsl/imx8m/edm_imx8m/wifi-firmware/QCA9377/utf30.bin))
PRODUCT_COPY_FILES += \
    device/fsl/imx8m/edm_imx8m/wifi-firmware/QCA9377/utf30.bin:vendor/firmware/utf30.bin
endif

# Qcom Bluetooth Firmware
PRODUCT_COPY_FILES += \
    vendor/nxp/qca-wifi-bt/qca_proprietary/Android_HAL/wcnss_filter_8mq:vendor/bin/wcnss_filter
ifneq (,$(wildcard device/fsl/imx8m/edm_imx8m/bluetooth/rampatch_tlv_3.2.tlv))
PRODUCT_COPY_FILES += \
    device/fsl/imx8m/edm_imx8m/bluetooth/rampatch_tlv_3.2.tlv:$(TARGET_COPY_OUT_VENDOR)/firmware/qca/tfbtfw11.tlv
endif
ifneq (,$(wildcard device/fsl/imx8m/edm_imx8m/bluetooth/nvm_tlv_3.2.bin))
PRODUCT_COPY_FILES += \
    device/fsl/imx8m/edm_imx8m/bluetooth/nvm_tlv_3.2.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/qca/tfbtnv11.bin
endif

# voice-hat relative firmware
PRODUCT_COPY_FILES += \
    device/fsl/imx8m/edm_imx8m/firmware/TFA9892N1A_stereo_32FS.cnt:vendor/firmware/tfa98xx.cnt

# bootanimation ui
PRODUCT_COPY_FILES += \
    device/fsl/imx8m/edm_imx8m/ui/bootanimation.zip:system/media/bootanimation.zip
