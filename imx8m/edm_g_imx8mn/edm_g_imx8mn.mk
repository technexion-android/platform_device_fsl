...
IMX_DEVICE_PATH := device/nxp/imx8m/edm_g_imx8mn
...
# Overrides
PRODUCT_NAME := edm_g_imx8mn
PRODUCT_DEVICE := edm_g_imx8mn
PRODUCT_MODEL := EDM_G_IMX8MN
...
PRODUCT_COPY_FILES += \
    device/nxp/imx8m/edm_g_imx8mn/camera_config_imx8mn.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/camera_config_imx8mn.json
...
PRODUCT_COPY_FILES += \
    device/nxp/imx8m/edm_g_imx8mn/powerhint_imx8mn.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/powerhint_imx8mn.json
...
PRODUCT_COPY_FILES += \
    device/nxp/imx8m/edm_g_imx8mn/thermal_info_config_imx8mn.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/thermal_info_config_imx8mn.json \
    device/nxp/imx8m/edm_g_imx8mn/external_camera_config.xml:$(TARGET_COPY_OUT_VENDOR)/etc/external_camera_config.xml
...
PRODUCT_COPY_FILES += \
    $(IMX_DEVICE_PATH)/bluetooth/wcnss_filter_8mn_ttymxc2:vendor/bin/wcnss_filter
...
ifneq ($(filter TRUE true 1,$(IMX_OTA_POSTINSTALL)),)
  ...
  PRODUCT_COPY_FILES += \
    out/target/product/edm_g_imx8mn/obj/UBOOT_COLLECTION/u-boot-imx8mn.imx:$(TARGET_COPY_OUT_VENDOR)/etc/bootloader0.img
endif
