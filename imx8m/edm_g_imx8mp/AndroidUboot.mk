...
MCU_SDK_IMX8MP_DEMO_PATH := $(IMX_MCU_SDK_PATH)/mcu-sdk/imx8mp/boards/evkmimx8mp/demo_apps/hello_world/armgcc
...
define build_mcu_image_core
	...
	cmake -DCMAKE_TOOLCHAIN_FILE="$4" -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=$3 -S $1 -B $(UBOOT_MCU_OUT)/$2 1>/dev/null; \
