...
PRODUCT_COPY_FILES += \
    device/nxp/imx8m/edm_g_imx8mp/powerhint_imx8mp.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/powerhint_imx8mp.json
...
PRODUCT_COPY_FILES += \
    device/nxp/imx8m/edm_g_imx8mp/thermal_info_config_imx8mp.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/thermal_info_config_imx8mp.json
...
ifneq ($(filter TRUE true 1,$(IMX_OTA_POSTINSTALL)),)
  ...
  PRODUCT_COPY_FILES += \
    out/target/product/edm_g_imx8mp/obj/UBOOT_COLLECTION/u-boot-imx8mp.imx:$(TARGET_COPY_OUT_VENDOR)/etc/bootloader0.img
endif
