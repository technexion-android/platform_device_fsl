...
# Overrides
PRODUCT_NAME := edm_g_imx8mp
PRODUCT_DEVICE := edm_g_imx8mp
PRODUCT_MODEL := EDM_G_IMX8MP
...
PRODUCT_COPY_FILES += \
    device/fsl/imx8m/edm_g_imx8mp/camera_config_imx8mp.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/camera_config_imx8mp.json \
    device/fsl/imx8m/edm_g_imx8mp/ov5640_camera_config_imx8mp.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/ov5640_camera_config_imx8mp.json \
    device/fsl/imx8m/edm_g_imx8mp/isp_camera_config_imx8mp.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/isp_camera_config_imx8mp.json
...
PRODUCT_COPY_FILES += \
    device/fsl/imx8m/edm_g_imx8mp/powerhint_imx8mp.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/powerhint_imx8mp.json
...
PRODUCT_COPY_FILES += \
    device/fsl/imx8m/edm_g_imx8mp/thermal_info_config_imx8mp.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/thermal_info_config_imx8mp.json
...
PRODUCT_COPY_FILES += \
    $(IMX_DEVICE_PATH)/bluetooth/wcnss_filter_8mp:vendor/bin/wcnss_filter
