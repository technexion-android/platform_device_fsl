...
IMX_DEVICE_PATH := device/fsl/imx6dq/tep5_imx6
...
TARGET_BOOTLOADER_BOARD_NAME := TEP5-IMX6

PRODUCT_MODEL := TEP5-IMX6
...
ifeq ($(GLOBAL_CPU_TYPE),IMX6Q)
  BOARD_PREBUILT_DTBOIMAGE := out/target/product/tep5_imx6/dtbo-imx6q.img
else ifeq ($(GLOBAL_CPU_TYPE),IMX6DL)
  BOARD_PREBUILT_DTBOIMAGE := out/target/product/tep5_imx6/dtbo-imx6dl.img
endif
