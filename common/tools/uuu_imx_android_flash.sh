...
options:
  ...
  -u uboot_feature  flash uboot or spl&bootloader image with "uboot_feature" in their names
                        ...
                        Below table lists the legal value supported now based on the soc_name provided:
                           ...
                           │                │  verdin-uuu evk-uuu 15x15-evk-uuu rpmsg 4GB 16GB                                                     │
                           ├────────────────┼──────────────────────────────────────────────────────────────────────────────────────────────────────┤
                           │   imx7ulp      │  evk-uuu                                                                                             │
                           └────────────────┴──────────────────────────────────────────────────────────────────────────────────────────────────────┘
...
imx8mp_uboot_feature=(dual trusty-dual trusty-rbidx-blob-dual evk-uuu trusty-secure-unlock-dual powersave trusty-powersave-dual fspi)
...
imx95_uboot_feature=(dual trusty-dual trusty-secure-unlock-dual evk-uuu verdin trusty-verdin-dual verdin-uuu 15x15 15x15-dual trusty-15x15-dual trusty-15x15-rbidx-blob-dual 15x15-evk-uuu rpmsg 4GB 16GB)
