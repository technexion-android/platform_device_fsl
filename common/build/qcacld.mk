...
qcacld_build_make_env = KERNEL_SRC=$(KERNEL_OUT) CONFIG_FORCE_MLO_SUPPORT=y \
	CONFIG_HDD_WLAN_START_WAIT_TIME=4000 CONFIG_CLD_HL_SDIO_CORE=y TARGET_BUILD_VARIANT=userdebug \
	ARCH=$(KERNEL_ARCH) CROSS_COMPILE=$(CROSS_COMPILE) $(CLANG_TO_COMPILE) \
