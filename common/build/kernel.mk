...
ifneq ($(TARGET_KERNEL_VENDOR_DEFCONF),)
KERNEL_CONFIG_VENDOR := $(realpath $(TARGET_KERNEL_SRC)/arch/$(KERNEL_SRC_ARCH)/configs/$(TARGET_KERNEL_VENDOR_DEFCONF))
else
KERNEL_CONFIG_VENDOR :=
endif
