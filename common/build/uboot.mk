...
$(UBOOT_BIN): $(UBOOTENVSH) | $(UBOOT_COLLECTION) $(UBOOT_OUT)
	...
	$(MAKE) -C $(UBOOT_IMX_PATH)/uboot-imx/ CROSS_COMPILE="$(UBOOT_CROSS_COMPILE_WRAPPER)" KBUILD_HOSTLDFLAGS="-static" O=$(realpath $(UBOOT_OUT)) envtools

.PHONY: bootloader $(UBOOT_BIN) $(UBOOTENVSH)

bootloader: $(UBOOT_BIN)
	[ -z "$(BOARD_OTA_BOOTLOADERIMAGE)" ] || cp -fp $(UBOOT_COLLECTION)/$(BOARD_OTA_BOOTLOADERIMAGE) $(PRODUCT_OUT)/bootloader.img
