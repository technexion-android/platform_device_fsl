...
# Overrides
PRODUCT_NAME := evk_943
PRODUCT_DEVICE := evk_943
PRODUCT_MODEL := EVK_943

TARGET_BOOTLOADER_BOARD_NAME := EVK_943
...
PRODUCT_COPY_FILES += \
    $(IMX_DEVICE_PATH)/powerhint_imx943.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/powerhint_imx943.json
...
PRODUCT_COPY_FILES += \
    $(IMX_DEVICE_PATH)/thermal_info_config_imx943.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/thermal_info_config_imx943.json
...
ifneq ($(filter TRUE true 1,$(IMX_OTA_POSTINSTALL)),)
  ...
  PRODUCT_COPY_FILES += \
    $(OUT_DIR)/target/product/$(firstword $(PRODUCT_DEVICE))/obj/UBOOT_COLLECTION/spl-imx943-trusty-dual.bin:$(TARGET_COPY_OUT_VENDOR)/etc/bootloader0.img
endif
...
# -------@block_camera-------
PRODUCT_COPY_FILES += \
    $(IMX_DEVICE_PATH)/camera_config_imx943.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/camera_config_imx943.json \
...
PRODUCT_COPY_FILES += \
    $(IMX_DEVICE_PATH)/init.imx943.lpddr4.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.nxp.additional.rc \
...
PRODUCT_COPY_FILES += \
    ...
    hardware/nxp/libbt/conf/nxp/evk_943/bt_vendor.conf:/vendor/etc/bluetooth/bt_vendor.conf
...
PRODUCT_COPY_FILES += \
    $(IMX_DEVICE_PATH)/init.imx943.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.nxp.imx943.rc \
