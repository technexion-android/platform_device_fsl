...
# tep1_mx7d default target for EXT4
...
TARGET_BOOTLOADER_BOARD_NAME := TEP1
PRODUCT_MODEL := TEP1_MX7D
...
BOARD_KERNEL_CMDLINE := console=ttymxc1,115200 init=/init androidboot.console=ttymxc1 consoleblank=0 cma=192 androidboot.hardware=freescale
...
BOARD_SECCOMP_POLICY += device/fsl/tep1_7d/seccomp
