...
TARGET_RECOVERY_FSTAB = device/fsl/edm1cf_pmic_6dq/fstab_sd.freescale
# build for ext4
PRODUCT_COPY_FILES +=	\
        device/fsl/edm1cf_pmic_6dq/fstab_sd.freescale:root/fstab.freescale
else
TARGET_RECOVERY_FSTAB = device/fsl/edm1cf_pmic_6dq/fstab_sd-f2fs.freescale
# build for f2fs
PRODUCT_COPY_FILES +=	\
        device/fsl/edm1cf_pmic_6dq/fstab_sd-f2fs.freescale:root/fstab.freescale
...
PRODUCT_MODEL := EDM1CF-PMIC-MX6DQ
...
TARGET_BOARD_DTS_CONFIG := imx6q-edm1-cf_tc0700.dtb imx6dl-edm1-cf_tc0700.dtb imx6q-edm1-cf-pmic_tc0700.dtb imx6dl-edm1-cf-pmic_tc0700.dtb imx6qp-edm1-cf-pmic_tc0700.dtb imx6q-edm1-cf-pmic_tc1000.dtb imx6dl-edm1-cf-pmic_tc1000.dtb imx6qp-edm1-cf-pmic_tc1000.dtb

BOARD_SEPOLICY_DIRS := \
       device/fsl/imx6/sepolicy \
       device/fsl/edm1cf_pmic_6dq/sepolicy

BOARD_SECCOMP_POLICY += device/fsl/edm1cf_pmic_6dq/seccomp
